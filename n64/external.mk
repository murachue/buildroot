...
ifeq ($(TARGETS_ROOTFS),rootfs-iso9660)
$(BINARIES_DIR)/n64linux.bin: world
	@$(call MESSAGE,"Packing boot-loader/kernel/rootfs into the master file")
	$(HOST_DIR)/usr/bin/mkn64bin.iso9660 $(BINARIES_DIR)/n64linux.bin $(BINARIES_DIR)/n64load.bin "BOOT/VMLINUX.BIN;1" $(BINARIES_DIR)/rootfs.$(patsubst rootfs-%,%,$(TARGETS_ROOTFS))
else
$(BINARIES_DIR)/n64linux.bin: world
	@$(call MESSAGE,"Packing boot-loader/kernel/rootfs into the master file")
