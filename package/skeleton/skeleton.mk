...
ifeq ($(BR2_INIT_BIN_SH),y)
define SKELETON_SYSTEM_SYMLINK_INIT_BIN_SH
	ln -sf ../bin/sh $(TARGET_DIR)/sbin/init
endef
TARGET_FINALIZE_HOOKS += SKELETON_SYSTEM_SYMLINK_INIT_BIN_SH
endif # BR2_INIT_BIN_SH
